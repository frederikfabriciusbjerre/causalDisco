...
#'
#' @param score tiered scoring object to be used. At the moment only score supported is \code{\linkS4class{TemporalBIC}}.
...
tges <- function(score, verbose = FALSE){
  stopifnot("Score must be of type TemporalBIC, the only score criterion suported by tges at the moment."= class(score)[1] == "TemporalBIC")
